...
class SniperPartyManager {
    ...
    async claimFunds(
        ...
        return this.contractInstance.write.claimFunds([partyId, voteOptionIndex, spent, proof, spentSalt, resultsCommitment, spentVoiceCreditsCommitment]);
    }
